...
import (
	dStub "github.com/nafhul/migrate/v4/database/stub"
	"github.com/nafhul/migrate/v4/source"
	sStub "github.com/nafhul/migrate/v4/source/stub"
)
...
func ExampleNewWithDatabaseInstance() {
	...
	// `import "github.com/nafhul/migrate/v4/database/postgres"`
...
func ExampleNewWithSourceInstance() {
	...
	// `import "github.com/nafhul/migrate/v4/source/stub"`
